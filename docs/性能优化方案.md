...
```bash
python scripts/benchmark_bigram_index.py --sample-mod 20
python scripts/benchmark_bigram_index.py --sample-mod 10 --output-dir temp/bigram_demo_10pct
```
...
```bash
python scripts/benchmark_bigram_index.py \
  --sample-mod 1 \
  --only-bigram \
